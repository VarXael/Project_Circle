#include "Project_Circle/MusicSystem/MusicGameplaySystem/PcMusicEventsSubsystem.h"
#include "Engine/DataTable.h"
#include "Project_Circle/MusicSystem/MusicImportSystem/PcMusicConfigurationData.h"

void UPcMusicEventsSubsystem::InitializePlayback(UPcMusicConfigurationData* SongConfig)
{
	ResetState();
...
void UPcMusicEventsSubsystem::UpdateMusicTime(float CurrentTimeSeconds)
{
...
void UPcMusicEventsSubsystem::ResetState()
{
...
void UPcMusicEventsSubsystem::ProcessMusicEvents()
{
...
void UPcMusicEventsSubsystem::UpdateRhythmSection(int32 InCurrentTimeMS)
{
...
void UPcMusicEventsSubsystem::ProcessBeatTicks(int32 InCurrentTimeMS)
{
